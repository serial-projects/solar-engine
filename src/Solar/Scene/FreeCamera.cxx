...
namespace Solar
{
    namespace Scene
    {
        void FreeCamera::Init(Solar::Core::Shared *shared_core)
        {
        ...
        void FreeCamera::ProcessMouse(const Solar::Types::I8 xoffset, const Solar::Types::I8 yoffset) {
        ...
        void FreeCamera::ProcessKeyboard()
        {
        ...
        void FreeCamera::Rotate(Solar::Types::D32 xoff, Solar::Types::D32 yoff)
        {
        ...
        void FreeCamera::Move(Solar::Scene::FreeCameraMovementDirections direction)
        {
