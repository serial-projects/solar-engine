...
namespace Solar
{
    namespace Core
    {
        ...
        {
            // Shader:
            void Shader::LoadVertexAndFragmentShader(const Solar::Types::String path)
            {
            ...
            void Shader::SetIntegerUniform(const Solar::Types::Character *key, Solar::Types::Integer value)
            {
                ShaderGetAddressAndImplementFunction(glUniform1i(location, value));
            }

            void Shader::SetDecimalUniform(const Solar::Types::Character *key, Solar::Types::D32 value)
            {
                ShaderGetAddressAndImplementFunction(glUniform1f(location, value));
            }

            void Shader::SetVectorTwoUniform(const Solar::Types::Character *key, const glm::vec2 &value)
            {
                ShaderGetAddressAndImplementFunction(glUniform2fv(location, 1, &value[0]));
            }

            void Shader::SetVectorThreeUniform(const Solar::Types::Character *key, const glm::vec3 &value)
            {
                ShaderGetAddressAndImplementFunction(glUniform3fv(location, 1, &value[0]));
            }

            void Shader::SetVectorFourUniform(const Solar::Types::Character *key, const glm::vec4 &value)
            {
                ShaderGetAddressAndImplementFunction(glUniform4fv(location, 1, &value[0]));
            }

            void Shader::SetMatrixTwoUniform(const Solar::Types::Character *key, const glm::mat2 &value)
            {
                ShaderGetAddressAndImplementFunction(glUniformMatrix2fv(location, 1, GL_FALSE, &value[0][0]));
            }

            void Shader::SetMatrixThreeUniform(const Solar::Types::Character *key, const glm::mat3 &value)
            {
                ShaderGetAddressAndImplementFunction(glUniformMatrix3fv(location, 1, GL_FALSE, &value[0][0]));
            }

            void Shader::SetMatrixFourUniform(const Solar::Types::Character *key, const glm::mat4 &value)
            {
            ...
            // Content Provider:
            Solar::Core::Storage::Shader* ContentProvider::GetShader(const Solar::Types::String key)
            {
